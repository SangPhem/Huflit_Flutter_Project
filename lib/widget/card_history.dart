    ...
    return Column(
        ...
        children: [
          Row(
            ...
            children: [Text( "Đơn Hàng:" + model.invoice!,style: boldTextStyle.copyWith(fontSize: 16)),Icon(Icons.arrow_forward_ios,size: 14,)],
          ),
          SizedBox(height: 6,),
          Text(model.orderAt!,style: regulerTextStyle.copyWith(fontSize: 16),
          ),
          SizedBox(height: 12,),
          Text(model.status == "1" ? "Đơn hàng đang được xác nhận" : "Đặt hàng thành công",style: lightTextStyle),
          Divider()
        ],
      );
  }
